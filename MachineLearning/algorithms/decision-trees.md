...
- **+** Base learner for ensembles — see [gradient-boosting](gradient-boosting.md), [XGBoost](XGBoost.md), [LightGBM](LightGBM.md), random forests, and the [base-estimator](base-estimator.md) role.
