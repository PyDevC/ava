...
1. **[[XGBoost]] / [[LightGBM]]** — best-in-class defaults for tabular data; fast, robust, handle missing values + categoricals.
2. **[[Gradient-boosting]]** — the family they belong to; understand it first.
...
- **Evaluation**: RMSE / MAE / R² depending on the business cost (see [[cost-function]]). Consider MAPE for relative errors.
...
- [[weighted-linear-regression]] — when samples have unequal importance.
- [[loss-function]] — pick RMSE vs MAE by outlier tolerance.
- [[descision-trees]] — the base learner underneath everything tree-based.
