...
- **Universal approximation** (see [[Universal-approximation-function]]): with injective encoders + smooth decoders you can build networks that separate distinct points while reconstructing them.
