...
- **tpot / auto-sklearn pipelines** — feature selection/preprocessing operators are part of the searched pipeline (see [tpot](tpot.md)).
...
- [this](automated-feature-extraction.md) is one stage of the AutoML pipeline — see [auto-sklearn](auto-sklearn.md).
- [metric-learning](metric-learning.md) is a special learned-feature technique (features that make similar pairs close).
