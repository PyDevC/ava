...
1. **ML fundamentals**: the training side ([PLAN](../MachineLearning/deeplearning/)) — you must know what the model does before you shrink it.
2. **The compiler stack**: [PLAN](../Compilers/DLCompilers/) — the tooling is where the job happens.
