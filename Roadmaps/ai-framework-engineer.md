...
- **Compilers**: IRs, SSA, lowering, codegen (my notes: [DLCompilers](../Compilers/DLCompilers/PLAN.md), [Dominators](../Compilers/IR/SSA/Dominators.md), [Affine](../Compilers/MLIR/Dialects/Affine.md)).
...
1. C++ (strong) + Python.
2. Compiler fundamentals: SSA, loops, codegen (start with my [Compilers](../Compilers/PLAN.md) notes).
