...
- **The language set**: a systems language (C++/Go/Rust) + a scripting language (Python) — the C++/Python combo here is directly it ([PLAN](../Programming/cpp/), [PLAN](../Programming/python/)).
...
- **Build + deploy**: CMake/Docker/Kubernetes/CI — [cpp-cmake](../Programming/cpp/cpp-cmake.md), [packaging](../Programming/python/packaging.md), and the OSS workflow ([OpenSource](../OpenSource/)).
...
2. **The languages**: Python deeply ([core](../Programming/python/core/)) then a systems language (the [PLAN](../Programming/cpp/) path).
