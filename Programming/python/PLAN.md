...
- [core](core/) — Python internals: bytecode, typechecking, subclass conditioning (see [PLAN](core/)).
...
- [x] (C++/other languages would be new sibling sub-directories, per [PLAN](../PLAN.md))
