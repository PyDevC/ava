...
- **Generated files** (MLIR `mlir-tblgen` outputs): they're build artifacts generated by a custom command — edit the `.td`, *not* the generated `.inc` (see [TableGen](../../Compilers/MLIR/TableGen.md)).
